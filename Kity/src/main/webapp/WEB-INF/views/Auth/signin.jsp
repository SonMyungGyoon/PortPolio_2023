...
<html lang="ko" data-bs-theme="auto">
  ...
  <body class="d-flex align-items-center py-4 bg-body-tertiary">
	...
	<main class="form-signin w-100 m-auto">
	  <form action = "/kity/Auth/signin" method = "POST">
	    <img class="mb-4" src="" alt="" width="72" height="57">
	    <h1 class="h3 mb-3 fw-normal">Please sign in</h1>
	
	    <div class="form-floating mb-1 mt-1">
	      <input type="text" class="form-control" id="floatingInput" placeholder="ID" name = "u_id">
	      <label for="floatingInput">ID</label>
	    </div>
	    <div class="form-floating mb-1 mt-1">
	      <input type="password" class="form-control" id="floatingPassword" placeholder="Password" name="u_pw">
	  ...
	  <p class="mt-1 mb-1"></p>
	  <a href="/kity/Auth/createaccount"><button class="btn btn-primary w-100 py-2">Create Account</button></a>
